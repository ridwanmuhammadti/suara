    ...
    <div class="col-12 col-md-12 col-lg-12">
      <div class="card">
        <div class="card-header">
          <a href="/keuangan/bulan/cetak" class="btn btn-sm btn-primary" target="_blank"><i class="fas fa-print"></i></i></a>
          ...
          <table class="table table-striped" id="table-1">
            ...
            <tbody>
              @foreach ($pemasukanbulan as $item)
              <tr>
                  <td>{{ $item->invoice }}</td>
